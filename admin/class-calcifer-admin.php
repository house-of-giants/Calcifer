...
class Calcifer_Admin
{
		...
		register_setting(
			...
			array(
				...
				'default' => array(
					...
					'show_branding' => true,
					'branding_text' => 'Calcifer',
					'branding_url' => 'https://houseofgiants.com',
	...
	public function sanitize_settings($input)
	{
		...
		$sanitized['branding_text'] = isset($input['branding_text']) ? sanitize_text_field($input['branding_text']) : 'Calcifer';
		$sanitized['branding_url'] = isset($input['branding_url']) ? esc_url_raw($input['branding_url']) : 'https://houseofgiants.com';
