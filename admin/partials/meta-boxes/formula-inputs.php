...
<div class="ac-formula-inputs">
  ...
  <div class="ac-inputs-container" id="ac-inputs-container">
    <?php if (!empty($inputs)): ?>
      <?php foreach ($inputs as $index => $input): ?>
        <div class="ac-input-item" data-index="<?php echo esc_attr($index); ?>">
          <h4>Input #<?php echo esc_html($index + 1); ?> <span class="ac-remove-input dashicons dashicons-no-alt"></span>
          </h4>

          <p>
            <label for="ac_inputs_<?php echo esc_attr($index); ?>_name">Variable Name:</label>
            <input type="text" id="ac_inputs_<?php echo esc_attr($index); ?>_name"
              name="ac_inputs[<?php echo esc_attr($index); ?>][name]" value="<?php echo esc_attr($input['name']); ?>"
          ...
          <p>
            <label for="ac_inputs_<?php echo esc_attr($index); ?>_label">Display Label:</label>
            <input type="text" id="ac_inputs_<?php echo esc_attr($index); ?>_label"
              name="ac_inputs[<?php echo esc_attr($index); ?>][label]" value="<?php echo esc_attr($input['label']); ?>"
              required>
            <span class="description">Label shown to users (e.g., "Weight in kg")</span>
          </p>

          <p>
            <label for="ac_inputs_<?php echo esc_attr($index); ?>_type">Input Type:</label>
            <select id="ac_inputs_<?php echo esc_attr($index); ?>_type"
              name="ac_inputs[<?php echo esc_attr($index); ?>][type]">
          ...
          <p>
            <label for="ac_inputs_<?php echo esc_attr($index); ?>_default">Default Value:</label>
            <input type="text" id="ac_inputs_<?php echo esc_attr($index); ?>_default"
              name="ac_inputs[<?php echo esc_attr($index); ?>][default]" value="<?php echo esc_attr($input['default']); ?>">
            <span class="description">Initial value when calculator loads</span>
          </p>

          <p>
            <label for="ac_inputs_<?php echo esc_attr($index); ?>_description">Description:</label>
            <textarea id="ac_inputs_<?php echo esc_attr($index); ?>_description"
              name="ac_inputs[<?php echo esc_attr($index); ?>][description]" rows="2"
          ...
          <p>
            <label for="ac_inputs_<?php echo esc_attr($index); ?>_required">
              <input type="checkbox" id="ac_inputs_<?php echo esc_attr($index); ?>_required"
                name="ac_inputs[<?php echo esc_attr($index); ?>][required]" value="1" <?php checked(!empty($input['required'])); ?>>
              Required
            </label>
          </p>
        </div>
  ...
  <p class="ac-actions">
    <button type="button" class="button button-secondary ac-add-input">Add Input</button>
    <span class="description" style="margin-left: 10px;">Add all variables used in your formula</span>
  </p>
</div>

<script type="text/template" id="ac-input-template">
    <div class="ac-input-item" data-index="{index}">
        <h4>Input #{number} <span class="ac-remove-input dashicons dashicons-no-alt"></span></h4>
        
        <p>
            <label for="ac_inputs_{index}_name">Variable Name:</label>
            <input type="text" id="ac_inputs_{index}_name" name="ac_inputs[{index}][name]" value="" 
              class="variable-name-input" required pattern="[a-zA-Z][a-zA-Z0-9]*">
            <span class="description">Must match a variable in your formula (e.g., "Weight")</span>
            <span class="validation-message"></span>
        </p>
        ...
        <p>
            <label for="ac_inputs_{index}_label">Display Label:</label>
            <input type="text" id="ac_inputs_{index}_label" name="ac_inputs[{index}][label]" value="" required>
            <span class="description">Label shown to users (e.g., "Weight in kg")</span>
        </p>
        
        <p>
            <label for="ac_inputs_{index}_type">Input Type:</label>
            <select id="ac_inputs_{index}_type" name="ac_inputs[{index}][type]">
        ...
        <p>
            <label for="ac_inputs_{index}_default">Default Value:</label>
            <input type="text" id="ac_inputs_{index}_default" name="ac_inputs[{index}][default]" value="">
            <span class="description">Initial value when calculator loads</span>
        </p>
        
        <p>
            <label for="ac_inputs_{index}_description">Description:</label>
            <textarea id="ac_inputs_{index}_description" name="ac_inputs[{index}][description]" rows="2" class="large-text"></textarea>
            <span class="description">Help text shown to users (e.g., "Enter your weight in kilograms")</span>
        </p>
        
        <p>
            <label for="ac_inputs_{index}_required">
                <input type="checkbox" id="ac_inputs_{index}_required" name="ac_inputs[{index}][required]" value="1" checked>
                Required
            </label>
        </p>
    </div>
